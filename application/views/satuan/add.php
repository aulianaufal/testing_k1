        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_satuan">Kode Satuan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-box-fill"></i></span>
                            </div>
                        <input value="<?= set_value('id_satuan'); ?>" name="id_satuan" id="id_satuan" type="text" class="form-control" placeholder="Kode Satuan..." >
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input value="<?= set_value('nama_satuan'); ?>" name="nama_satuan" id="nama_satuan" type="text" class="form-control" 
