        ...
        <div class="card shadow-sm border-bottom-dark">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('barang') ?>" class="btn btn-sm bg-gradient-light btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            <select name="id_jenis" id="jenis_id" class="custom-select">
                                ...
                                <?php foreach ($jenis as $j): ?>
                                    <option <?= set_select('id_jenis', $j['id_jenis']) ?> value="<?= $j['id_jenis'] ?>">
                                        <?= $j['nama_jenis'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_satuan">Satuan Barang</label>
                    <div class="col-md-6">
                        <div class="input-group">
                            <select name="id_satuan" id="id_satuan" class="custom-select">
                                <option value="" selected disabled>Pilih Satuan Barang</option>
                                <?php foreach ($satuan as $s): ?>
                                    <option <?= set_select('id_satuan', $s['id_satuan']) ?> value="<?= $s['id_satuan'] ?>">
                                        <?= $s['nama_satuan'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                                <a class="btn btn-secondary" href="<?= base_url('satuan/add'); ?>"><i
                                        class="fa fa-plus"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <select name="id_supplier" id="id_supplier" class="custom-select">
                                ...
                                <?php foreach ($supplier as $sup): ?>
                                    <option <?= set_select('id_supplier', $sup['id_supplier']) ?>
                                        value="<?= $sup['id_supplier'] ?>"><?= $sup['nama_supplier'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('harga_beli'); ?>" name="harga_beli" id="harga_beli" type="number"
                            class="form-control" placeholder="Harga Beli...">
                        <?= form_error('harga_beli', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <!-- Add these fields to the form in add.php -->
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="potongan1">Potongan 1 (%)</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="potongan2">Potongan 2 (%)</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="potongan3">Potongan 3 (%)</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="ppn">PPN (%)</label>
                    <div class="col-md-6">
                        <select name="ppn" id="ppn" class="form-control">
                            <?php for ($i = 0; $i <= 20; $i++): ?>
                                <option value="<?= $i ?>" <?= set_select('ppn', $i, $i == 0) ?>><?= $i ?>%</option>
                            <?php endfor; ?>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control" name="harga_jual" id="harga_jual"
                            value="<?= set_value('harga_jual'); ?>" placeholder="Harga Jual">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('stok', 0); ?>" name="stok" id="stok" type="number" min="0"
