        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-gray-dark text-uppercase mb-1">Total Data Barang</div>
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header bg-gradient-dark py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        if ($barang_min) :
                            foreach ($barang_min as $b) :
                                ...
                                <tr>
                                    ...
                                    <td><?= $b['stok']; ?></td>
                                    <td>
                                        <a href="<?= base_url('barang_masuk/add/') . $b['id_barang'] ?>" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                ...
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_masuk'] as $tbm) : ?>
                            <tr>
                                <td><strong><?= $tbm['tanggal']; ?></strong></td>
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3">
                <h6 class="m-0 font-weight-bold text-white">Daftar Customer</h6>
            </div>
            <div class="table-responsive">
                <table class="table table-striped table-sm mb-0">
                    ...
                    <tbody>
                        <?php if (!empty($customer_list)) : ?>
                            <?php $no = 1; foreach ($customer_list as $cust) : ?>
                                <tr>
